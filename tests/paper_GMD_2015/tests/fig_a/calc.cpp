...
int main(int ac, char** av)
{
  ...
  string opts_common = 
    "--outfreq=150 --nt=15000 --spinup=7500 --nx=76 --nz=76 --relax_th_rv=false --src_t0=40000 --src_t1=96000";
  set<string> opts_micro({
//    "--micro=blk_1m --outdir=out_blk_1m",
//    "--micro=blk_2m --outdir=out_blk_2m",
    "--micro=lgrngn --outdir=out_lgrngn --backend=multi_CUDA --sd_conc=128 --src_sd_conc=64 --supstp_src=200 --sstp_cond=10 --sstp_coal=1"  
      " --out_wet=\""
