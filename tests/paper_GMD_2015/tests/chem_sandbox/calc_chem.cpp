...
int main(int ac, char** av)
{
  ...
  for (const string &kernel : {"geometric", "long", "hall", "hall_davis_no_waals", "golovin", "onishi_hall", "onishi_hall_davis_no_waals", "vohl_davis_no_waals", "hall_pinsky_cumulonimbus", "hall_pinsky_stratocumulus"})
  {
