...
namespace libcloudphxx
{
  namespace common
  {
    ...
    namespace dissoc
    {
      ...
      libcloudphxx_const(amount_square_over_volume_square, K_H2O, real_t(1e-14 * 1e6) , si::moles * si::moles / si::cubic_metres / si::cubic_metres)

      //SO2 * H20 -> HSO3, SO3
      libcloudphxx_const(amount_over_volume, K_SO2,  real_t(1.3e-2 * 1e3), si::moles / si::cubic_metres)
      libcloudphxx_const(amount_over_volume, K_HSO3, real_t(6.6e-8 * 1e3), si::moles / si::cubic_metres)

      //H2SO4 -> HSO4, SO4
      // assumes no not-dissociated H2SO4 (see Seinfeld & Pandiss p. 388)
      libcloudphxx_const(amount_over_volume, K_HSO4, real_t(1.2e-2 * 1e3), si::moles / si::cubic_metres) 

      //CO2 * H20 -> HCO3, CO3
      libcloudphxx_const(amount_over_volume, K_CO2,  real_t(4.3e-7 * 1e3), si::moles / si::cubic_metres)
      libcloudphxx_const(amount_over_volume, K_HCO3, real_t(4.68e-11 * 1e3), si::moles / si::cubic_metres)

      //NH3 * H20 -> NH4
      libcloudphxx_const(amount_over_volume, K_NH3,  real_t(1.7e-5 * 1e3), si::moles / si::cubic_metres)

      //HNO3 -> NO3
      libcloudphxx_const(amount_over_volume, K_HNO3,  real_t(15.4 * 1e3), si::moles / si::cubic_metres)
