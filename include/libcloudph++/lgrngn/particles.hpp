...
namespace libcloudphxx
{
  namespace lgrngn
  {
    ...
    struct particles_t: particles_proto_t<real_t>
    {
      ...
      // constructor
      particles_t(const opts_init_t<real_t> &opts_init, const int &n_x_bfr = 0, const bool &distmem_mpi = 0, const bool &distmem_cuda = 0); // only opts_init specified by user
