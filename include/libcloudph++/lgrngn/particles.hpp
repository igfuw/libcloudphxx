...
namespace libcloudphxx
{
  namespace lgrngn
  {
    ...
    struct particles_t: particles_proto_t<real_t>
    {
      ...
      // constructor
      particles_t(opts_init_t<real_t> opts_init, const int &n_x_bfr, int n_x_tot = 0); // n_x_bfr should have default=0, but python bindings fail if more than one default value...
