...
BOOST_PYTHON_MODULE(libcloudphxx)
{
  ...
  // lgrngn stuff
  {
    ...
    bp::class_<lgr::opts_init_t<real_t>>("opts_init_t")
      ...
      .def_readwrite("chem_dsl", &lgr::opts_init_t<real_t>::chem_dsl)
      .def_readwrite("chem_dsc", &lgr::opts_init_t<real_t>::chem_dsc)
      .def_readwrite("chem_rct", &lgr::opts_init_t<real_t>::chem_rct)
