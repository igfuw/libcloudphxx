...
BOOST_PYTHON_MODULE(libcloudphxx)
{
  ...
  // lgrngn stuff
  {
    ...
    bp::class_<lgr::particles_proto_t<real_t>/*, boost::noncopyable*/>("particles_proto_t")
      ...
      .def("diag_revp20",&lgr::particles_proto_t<real_t>::diag_revp20)
      .def("diag_revp25",&lgr::particles_proto_t<real_t>::diag_revp25)
      .def("diag_revp32",&lgr::particles_proto_t<real_t>::diag_revp32)
      .def("diag_accr20",&lgr::particles_proto_t<real_t>::diag_accr20)
      .def("diag_accr25",&lgr::particles_proto_t<real_t>::diag_accr25)
      .def("diag_accr32",&lgr::particles_proto_t<real_t>::diag_accr32)
      .def("diag_acnv20",&lgr::particles_proto_t<real_t>::diag_acnv20)
      .def("diag_acnv25",&lgr::particles_proto_t<real_t>::diag_acnv25)
