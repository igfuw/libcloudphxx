...

      {
        ...
        thrust::transform(
          zip_it_t(thrust::make_tuple(
            ...
            V.begin(), thrust::make_permutation_iterator(T_ref.begin(), ijk.begin_ref()), rw2.begin())),                   // input - begin
          zip_it_t(thrust::make_tuple(
            chem_end[SO2], chem_end[CO2], chem_end[HNO3], chem_end[NH3], chem_end[S_VI], chem_end[H],
            V.end(), thrust::make_permutation_iterator(T_ref.end(), ijk.end_ref()), rw2.end())),                           // input - end
