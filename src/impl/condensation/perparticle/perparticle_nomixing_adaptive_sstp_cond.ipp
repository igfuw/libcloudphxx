    ...
    namespace detail
    {
      ...
      struct perparticle_nomixing_adaptive_sstp_cond_loop
      {
        ...
        ) //noexcept
        {
          ...
          real_t delta_revp20 = thrust::get<3>(thrust::get<2>(tpl));
          real_t delta_revp25 = thrust::get<4>(thrust::get<2>(tpl));
          real_t delta_revp32 = thrust::get<5>(thrust::get<2>(tpl));
          ...
          for(int step = 0; step < sstp_cond; ++step)
          {
            ...
            // sstp_tmp_th += drw3; // updating th is disabled in KidA
          }
          ...
          thrust::get<3>(thrust::get<2>(tpl)) = delta_revp20;
          thrust::get<4>(thrust::get<2>(tpl)) = delta_revp25;
          thrust::get<5>(thrust::get<2>(tpl)) = delta_revp32;
        }
      };
    };
