...
namespace libcloudphxx
{
  namespace lgrngn
  {
    ...
    void particles_t<real_t, device>::impl::init_T_freeze() {
      ...
      thrust::transform(
        thrust::make_zip_iterator(thrust::make_tuple(rd2_insol.begin() + n_part_old, u01.begin())),
        thrust::make_zip_iterator(thrust::make_tuple(rd2_insol.begin() + n_part_old, u01.begin())) + n_part_to_init,
