...
namespace libcloudphxx
{
  namespace lgrngn
  {
    ...
    void particles_t<real_t, device>::impl::hskpng_remove_n0()
    {
      ...
      std::vector<thrust_device::vector<real_t>*> real_t_vctrs = {&rd3, &rw2, &kpa, &vt, &delta_revp20, &delta_revp25, &delta_revp32, &delta_accr20, &delta_accr25, &delta_acnv20, &delta_acnv25, &delta_accr32, &delta_acnv32};
