...
namespace libcloudphxx
{
  namespace lgrngn
  {
    ...
    template <typename real_t, backend_t device>
    void particles_t<real_t, device>::diag_revp20()
    {
      thrust::copy(
        pimpl->revp20.begin(), 
        pimpl->revp20.end(), 
    ...
    // records accretion with rain r>20
    template <typename real_t, backend_t device>
    void particles_t<real_t, device>::diag_revp25()
    {
      thrust::copy(
        pimpl->revp25.begin(), 
        pimpl->revp25.end(), 
    ...
    // records accretion with rain r>20
    template <typename real_t, backend_t device>
    void particles_t<real_t, device>::diag_revp32()
    {
      thrust::copy(
        pimpl->revp32.begin(), 
        pimpl->revp32.end(), 
    ...
    // records accretion with rain r>25
    template <typename real_t, backend_t device>
    void particles_t<real_t, device>::diag_accr25()
    {
      thrust::copy(
        pimpl->accr25.begin(), 
        pimpl->accr25.end(), 
    ...
    // records acnvetion with rain r>25
    template <typename real_t, backend_t device>
    void particles_t<real_t, device>::diag_acnv25()
    {
      thrust::copy(
        pimpl->acnv25.begin(), 
        pimpl->acnv25.end(), 
