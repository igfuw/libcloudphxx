  ...
  namespace lgrngn
  {
    ...
    void particles_t<real_t, device>::impl::init_hskpng_npart()
    {
      ...
      if(opts_init.chem_switch)
      {
        ...
        tmp_device_real_part_V_old.reserve(opts_init.n_sd_max);// TODO: only in chemistry, but can we do without it?
        tmp_device_real_part_mass.reserve(opts_init.n_sd_max); // TODO: only in chemistry, maybe not needed?
